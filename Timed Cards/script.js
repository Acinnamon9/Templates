...
function updateDimensions() {
    ...
    // Scaled dimensions based on viewport
    cardWidth = Math.min(width * 0.15, 200);
    cardHeight = cardWidth * 1.5;
    gap = width * 0.03;
    numberSize = 50;

    offsetTop = height - cardHeight - 120;
    offsetLeft = width - (cardWidth + gap) * 4 - 100;

    if (width < 768) {
        // Mobile adjustments
        cardWidth = width * 0.3;
        cardHeight = cardWidth * 1.4;
        offsetLeft = width - (cardWidth + 20) * 2 - 20;
