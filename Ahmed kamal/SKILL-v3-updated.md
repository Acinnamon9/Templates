...
window.addEventListener('DOMContentLoaded', function() {
  ...
  (function(){
    // GSAP setup — all ScrollTrigger registrations here
    gsap.registerPlugin(ScrollTrigger);
    // hero parallax, timeline fill, revealUp calls, counters, etc.
  })();
...
- [ ] S7 approach stack: translate offset + shadow only (optical depth, not 3D)
